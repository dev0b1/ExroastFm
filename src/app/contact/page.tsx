  ...
  return (
    <main className="max-w-3xl mx-auto py-12 px-4">
      ...
      <section className="mb-8">
        ...
        <p className="text-sm text-gray-700">For support and billing, email <a href="mailto:contact@exroast.buzz" className="text-blue-600 underline">contact@exroast.buzz</a> and we'll reply within 1 business day.</p>
      </section>

      <section className="mb-8">
        <h2 className="text-lg font-semibold mb-2">Business / Legal</h2>
        <p className="text-sm text-gray-700">For legal and billing matters contact <a href="mailto:contact@exroast.buzz" className="text-blue-600 underline">contact@exroast.buzz</a>.</p>
